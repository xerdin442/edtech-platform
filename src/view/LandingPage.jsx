...
const LandingPage = () => {
  const [highlightUniqueFeature, setHighlightUniqueFeature] = useState("Income tracking");
  ...
  const faqs = [
    { question: "Is EduDesks suitable for schools of any size?", answer: "Yes! EduDesks is built to be flexible and scalable, making it ideal for schools of all sizes, from small institutions to large educational networks." },

    { question: "How do I get started?", answer: "Sign up and follow the easy onboarding steps to set up your school’s financial system." },
    
    { question: "How easy is it to set up EduDesks?", answer: "Very easy! EduDesks has a simple setup process, with guided steps to get you up and running fast." },

    { question: "What does EduDesks do?", answer: "EduDesk helps schools track income, manage expenses, and stay on budget with real-time insights and automated reports" },

    { question: "Who is EduDesks for?", answer: "EduDesk is for school administrators, finance managers, and staff looking to simplify financial management." },

    { question: "Can I track income and expenses?", answer: "Absolutely! EduDesks lets you easily track and categorize income and expenses, making budgeting simple." },
  ];
  return (
    <>
      <LandingPageHeader />
      <main className="landingPageContainer">
        ...
        <section className="firstPart">
          ...
          <img src={elements} alt="Down Left Arrow" />
        </section>
        ...
        <section className="thirdPart">
          ...
          <div className="uniqueFeatures">
            ...
            {/* income tracking */}
            <div className="uniqueFeaturesLower" style={{ display: highlightUniqueFeature === "Income tracking" ? "block" : "none" }}>
              <div className="tracking-container">
                  ...
                  <button>
                    ...
                    <p>
                      Managing your finances is simpler with comprehensive
                      income tracking. Our platform provides a clear and
                      detailed view of your earnings, helping you monitor every
                      income stream effortlessly.
                    </p>
                  </div>

                  <div className="smaller-tracking-2">
                    <img src={Monthly_Chart_1} alt="Monthly Chart 1" className="chart1" />
                    <img src={income_report_1} alt="Income Report 1" className="chart2" />
                </div>
              </div>
            </div>

            {/* expense tracking */}
            <div className="uniqueFeaturesLower" style={{ display: highlightUniqueFeature === "Expense tracking" ? "block" : "none" }}>
              <div className="tracking-container">
                  <div className="smaller-tracking-1">
                  <button>
                    <img src={cash_icon} alt="cash icon" />
                    ...
                    <p>
                    EduDesk’s Expenses Tracking feature is designed to help schools manage their spending with precision. This tool gives schools full visibility into their financial outflows, making it easier to plan, budget, and stay on top of their financial health.
                    </p>
                  </div>

                  <div className="smaller-tracking-2 expense-tracking">
                    <img src={Expense_overview} alt="Expense overview" className="chart1" />
                </div>
              </div>
            </div>

            {/* fees Payment */}
            <div className="uniqueFeaturesLower" style={{ display: highlightUniqueFeature === "fees Payment" ? "block" : "none" }}>
              <div className="tracking-container">
                  <div className="smaller-tracking-1">
                  <button>
                    <img src={cash_icon} alt="cash icon" />
                    ...
                    <p>
                    Edudesk simplifies school fee management with efficient tracking tools designed for both schools and parents.With our platform, schools can effortlessly monitor fee payments, send automated reminders, and generate detailed reports.
                    </p>
                  </div>

                  <div className="smaller-tracking-2 expense-tracking">
                    <img src={payment_status} alt="payment_status" className="chart1" />
                </div>
              </div>
            </div>

            {/* Analytics */}
            <div className="uniqueFeaturesLower" style={{ display: highlightUniqueFeature === "Analytics" ? "block" : "none" }}>
              <div className="tracking-container">
                  <div className="smaller-tracking-1">
                  <button>
                    <img src={cash_icon} alt="cash icon" />
                    ...
                    <p>
                    Edudesk helps you turn data into actionable information, helping you track performance, identify trends, and make data-driven decisions. 
                    </p>
                  </div>

                  <div className="smaller-tracking-2">
                    <img src={Monthly_Chart_2} alt="Monthly Chart 2" className="chart1" />
                    <img src={Monthly_Chart_3} alt="Monthly_Chart_3" className="chart2" />
                </div>
              </div>
            </div>
          </div>
            ...
            <ul>
              <li>
                ...
                <div>
                  ...
                  <p>
                    Quickly sign up and input your school’s basic details to get
                    started with our financial management too.
                  </p>
                </div>
              </li>
              ...
              <li>
                ...
                <div>
                  ...
                  <p>
                    Complete email verification by clicking a link sent to your
                    registered email.
                  </p>
                </div>
              </li>
              ...
              <li>
                ...
                <div>
                  ...
                  <p>
                    ...
                    profile picture, imputing basic details and specify
                    membership type.
                  </p>
                </div>
              </li>
              ...
              <li>
                ...
                <div>
                  ...
                  <p>
                    ...
                    redirected to your dashboard where you can access Edudesk’s
                    features.
                  </p>
                </div>
              </li>
        ...
        <div key={index} className="faq-item">
          ...
          >
            <h6>{faq.question}</h6>
            <span>{activeFaq === index ? <img src={minus_circle} alt="minus circle"/> : <img src={plus_circle} alt="plus circle"/>}</span>
          </div>
          {activeFaq === index && (
